...
def get_vocab(text):
    ...
    print("text.strip().split(): ", text.strip().split())
    # 去头去尾再根据空格split
...
输入:
    vocab: Dict[str, int]  # vocab 统计了词语出现的词频  

输出:
    pairs: Dict[Tuple[str, str], int] # 字母对, pairs 统计了单词对出现的频率
"""
